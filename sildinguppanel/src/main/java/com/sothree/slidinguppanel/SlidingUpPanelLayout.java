...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    /**
     * Default height of the no_shadow above the peeking out panel
     */
    ...
    /**
     * Drawable used to draw the no_shadow between panes.
     */
    ...
    /**
     * The size of the no_shadow in pixels.
     */
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        // If the no_shadow height is zero, don't show the no_shadow
        if (mShadowHeight > 0) {
            if (mIsSlidingUp) {
...
//                mShadowDrawable = getResources().getDrawable(R.drawable.below_shadow);
            ...
            mShadowDrawable = getResources().getDrawable((R.drawable.no_shadow));
        } else {
            mShadowDrawable = null;
        }
    ...
    /**
     * @return The current no_shadow height
     */
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (mSlideableView != null && mSlideableView != child) { // if main view
            ...
            if (mCoveredFadeColor != 0 && mSlideOffset > 0) {
                ...
                final int color = imag << 24 | (mCoveredFadeColor & 0x00ffffff);
